...
export default {
  ...
  methods: {
    runAnimation() {
      ...
      var options = {
        particleColor: '#CCC',
        background: require('../assets/MA-banner.jpg'),
        interactive: false,
        speed: 'medium',
        density: 1e4,
      };
