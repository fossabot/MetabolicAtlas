            ...
            <div class="card">
              <div class="columns is-mobile is-multiline margin-fix">
                ...
                <div class="column more-padding is-v-aligned">
                  <router-link :to="currentMenu.routerLocation">
    ...
    return {
      menu: [
        { title: 'Welcome',
          ...
          cardLink: 'Explore',
          routerLocation: { name: 'explorerRoot' },
          icon: 'home' },
        { title: messages.gemBrowserName,
          ...
          routerLocation: { name: 'browserRoot', params: { model: 'human1' } },
          icon: 'table' },
        { title: messages.mapViewerName,
          ...
          routerLocation: { name: 'viewerRoot', params: { model: 'human1' } },
          icon: 'map-o' },
        { title: messages.interPartName,
          ...
          routerLocation: { name: 'interPartner', params: { model: 'human1', id: 'm02007p' } },
          icon: 'connectdevelop' },
        { title: 'Search',
          ...
          routerLocation: { name: 'search', query: { term: '' } },
          icon: 'search' },
        { title: 'Analyze',
