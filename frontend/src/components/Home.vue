    ...
    return {
      menu: [
        ...
        { title: messages.gemBrowserName,
          ...
          routeName: { name: 'browserRoot', params: { model: 'human1' } },
          icon: 'table' },
        { title: messages.mapViewerName,
          ...
          routeName: { name: 'viewerRoot', params: { model: 'human1' } },
          icon: 'map-o' },
        { title: messages.interPartName,
          ...
          routeName: { name: 'interPartner', params: { model: 'human1', id: 'm02007p' } },
          icon: 'connectdevelop' },
        { title: 'Search',
          ...
          routeName: { name: 'search', query: { term: '' } },
          icon: 'search' },
        { title: 'Analyze',
