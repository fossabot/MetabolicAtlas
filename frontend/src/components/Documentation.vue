      ...
      <div class="columns is-variable is-8">
        <div class="column is-narrow">
          <aside class="menu">
            ...
            <ul class="menu-list">
              <li>
                <a href="#resources"><b>Explore integrated models</b></a>
                <ul class="menu-list">
        ...
        <div class="column content is-medium">
          <h3 id="">Explore integrated models</h3>
          ...
          <h5 id="">Graph customization</h5>

          <h6 id="">Shape and color</h6>
          ...
          <h6 id="">Zoom in and out</h6>
          Simply press either the <b>+</b> or <b>-</b> button to zoom in the graph.

          <h6 id="">Fit the graph to the window size</h6>
          ...
          <h3 id="">The whole metabolic network</h3>
